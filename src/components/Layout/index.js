    ...
    return (
      <div className='site-wrapper'>
        ...
        <main className={classes.join(' ')}>
          ...
          <Starfield width={window.innerWidth} height={window.innerHeight} ref="starfield" />
          {this.props.children}
        </main>
        <Footer />
      </div>
